...
1. 点击左侧导航栏"生成密钥"
2. 输入密钥名称（如：id_rsa）
3. 选择密钥类型（RSA 2048位 / RSA 4096位 / Ed25519）
4. 选择存储路径（点击"选择路径"按钮）
5. 可选：添加备注信息
6. 可选：设置密码保护私钥
7. 点击"生成密钥"按钮
...
├── utils/
│   ├── key_generator.dart       # RSA/Ed25519密钥生成器
